...
public class HexUtil {
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(HexUtil.class);
    //Key trans path
    ...
    public static boolean checkHexStr(String sHex) {
        ...
        String sTmp = sHex.toString().trim().toUpperCase(Locale.US);
    ...
    public static String str2HexStr(String str) {
        try {
            ...
            logger.error("str2HexStr exception", ex);
            return null;
        }
    }
    ...
    public static String hexStr2Str(String hexStr) {
        try {
            ...
            hexStr = hexStr.toString().trim().toUpperCase(Locale.US);
